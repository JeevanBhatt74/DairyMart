  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          "Create Account", 
          style: GoogleFonts.poppins(color: theme.colorScheme.onSurface, fontWeight: FontWeight.w600)
        ),
        centerTitle: true,
      ),
      body: SafeArea(
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                Text("Let's Get Started!", style: GoogleFonts.poppins(fontSize: 26, fontWeight: FontWeight.bold, color: isDark ? Colors.white : const Color(0xFF2D2D2D)), textAlign: TextAlign.center),
